...
void main()
{
    ...
    float dx=.0033*snoise_octaves(uv*2.+iTime*vec2(.00323,.00345),9,.85,-3.,iTime*vec2(-.0323,-.345),1.203);
    float dy=.0023*snoise_octaves(uv*2.+3.+iTime*vec2(-.00323,.00345),9,.85,-3.,iTime*vec2(-.0323,-.345),1.203);
