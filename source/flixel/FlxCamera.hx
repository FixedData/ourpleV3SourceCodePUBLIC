...
class FlxCamera extends FlxBasic
{
	...
	override public function update(elapsed:Float):Void
	{
		...
		flashSprite.filters = (ClientPrefs.shaders && filtersEnabled) ? filters : null;
	 ...
	 */
	 public function onResize():Void
		...
		public function fixShaderCoords():Void //this is beautiful
		{
			if (flashSprite.filters == null) return;
			@:privateAccess
			{
